document.addEventListener('DOMContentLoaded', () => {
    ...
    .then(user => {
        ...
        if (loginLink) {
        loginLink.innerHTML = `<div style=" display: flex; align-items: center; gap: 10px; padding: 8px 12px; border-radius: 10px; background: white; box-shadow: 0 0 10px rgba(0,0,0,0.2);">
